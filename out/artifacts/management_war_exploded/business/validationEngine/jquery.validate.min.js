...
$.extend( $.validator, {
	...
	messages: {
        ...
        postalcode:"Please enter a valid postalcode.",
        idcard:"Please enter a valid idcard.",
        fax:"Please enter a valid fax.",
	...
	methods: {
		...
		telephone: function( value, element ) {
			return this.optional( element ) || /^(\d{3,4}-)?\d{7,8}(-\d{1,8})?$/.test( value );
		},
        postalcode: function( value, element ) {
            return this.optional( element ) || /^\d{6}$/.test( value );
        },
        idcard: function( value, element ) {
            return this.optional( element ) || /^(([0-9]{15})|([0-9]{17}[0-9x]))$/.test( value );
        },
        fax: function( value, element ) {
            return this.optional( element ) || /^(\d{3,4}-)?\d{7,8}(-\d{1,8})?$/.test( value );
        },
        double: function( value, element ) {
