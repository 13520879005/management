...
<script type="text/javascript">
    ...
    function fn_submit(){
        ...
        $.ajax({
            url:'<%=basePath%>depart/updateDepart.xhtml',
            type:'POST',
            dataType: "json",
...
<body>
  <div class="page-table" >
    <form id="form1">
      <input type="hidden" name="departcode"  value="${departMap.departcode}">
        ...
        <c:when test="${departMap.departparentcode == '00'}">
          <tr>
            ...
            <td class="td_i" colspan="3">
              <div>
                <input class="inputstyle validate[required]" type="text" name="departname" value="${departMap.departname}"  maxlength="100">
              </div>
            </td>
          </tr>
        </c:when>
