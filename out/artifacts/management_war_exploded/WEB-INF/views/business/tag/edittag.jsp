...
<script type="text/javascript">
    ...
    function fn_submit(){
        ...
        $.ajax({
            url:'<%=basePath%>tag/updateTag.xhtml',
            type:'POST',
            dataType: "json",
  ...
  <div class="page-table" >
    ...
    <table width="100%"  border="0" cellspacing="0" cellpadding="14">
      <br>
          ...
          <tr>
            <td class="td_s"><span style="color:#F00">*</span>课程名称：</td>
            <td class="td_i" colspan="3">
              <div>
                <input class="inputstyle validate[required]" type="text"  name="tagname" value="${tagMap.tagname}"  maxlength="100">
              </div>
            </td>
          </tr>
      <tr>
